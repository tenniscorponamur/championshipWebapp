...
export class PouleService {
    ...
    updatePouleAllerRetour(pouleId: number, allerRetour:boolean) {
        return this.http.put<Poule>(environment.privateApiUrl + "/poule/allerRetour?pouleId=" + pouleId + "&allerRetour=" + allerRetour, null, this.authenticationService.getPrivateApiHttpOptions());
    }
